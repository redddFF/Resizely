...
export const metadata: Metadata = {
  title: 'About Resizely | Free Online Image Resizer',
  description:
    'Learn about Resizely, the privacy-first online image resizing tool built for creators, marketers, and teams who need fast format-ready images.',
  alternates: {
    canonical: '/about',
  },
};
    ...
    <main className="min-h-full bg-background">
      <article className="container mx-auto max-w-3xl px-4 py-10 md:py-14">
        <header className="mb-8 space-y-3">
          <h1 className="text-3xl font-bold text-foreground md:text-4xl">About Resizely</h1>
          <p className="text-muted-foreground">
            Resizely is a free online image resizer designed to help creators publish faster without sacrificing quality.
          </p>
        </header>
        ...
        <section className="space-y-4 text-foreground leading-7">
          ...
          <p>
            ...
            blogs, and ad networks all use different dimensions, and those requirements change often. Resizely removes that
        ...
        <section className="mt-8 space-y-4 text-foreground leading-7">
          ...
          <p>
            Resizely processes images directly in your browser using modern Canvas APIs. In typical use, your files stay on
        ...
        <section className="mt-8 space-y-4 text-foreground leading-7">
          ...
          <p>
            Resizely helps content creators publishing daily posts, marketers building campaign assets, developers managing
          ...
          <p>
            ...
            use. As platforms evolve, we keep Resizely updated so your publishing pipeline stays efficient.
          </p>
        </section>
      </article>
    </main>

...
export const metadata: Metadata = {
  title: 'Terms of Service | Resizely',
  description:
    'Review the Resizely terms of service covering acceptable use, content responsibility, availability, and legal limitations.',
  alternates: {
    canonical: '/terms',
  },
};
    ...
    <main className="min-h-full bg-background">
      <article className="container mx-auto max-w-3xl px-4 py-10 md:py-14">
        ...
        <section className="space-y-4 text-foreground leading-7">
          ...
          <p>
            These Terms of Service govern your access to and use of Resizely. By using the website, you agree to these
        ...
        <section className="mt-8 space-y-4 text-foreground leading-7">
          ...
          <p>
            Resizely provides online image resizing tools for personal and commercial workflows. You are responsible for how
        ...
        <section className="mt-8 space-y-4 text-foreground leading-7">
          ...
          <p>
            Resizely and its branding, layout, and software components are protected by applicable intellectual property
            laws. You retain ownership of the files you process, while granting no ownership rights to Resizely solely by
            using the tool.
          </p>
          <p>
        ...
        <section className="mt-8 space-y-4 text-foreground leading-7">
          ...
          <p>
            To the maximum extent permitted by law, Resizely is not liable for indirect, incidental, consequential, or data-
        ...
        <section className="mt-8 space-y-4 text-foreground leading-7">
          ...
          <p>
            ...
            date. Continued use of Resizely after publication indicates acceptance of the revised terms.
          </p>
        </section>
      </article>
    </main>
